...
public class TestComputeOperator extends TestCase {
	...
	public void test1Op() throws Exception {
		...
		op.addPrepareSQL("CREATE TEMPORARY TABLE REGION ( R_REGIONKEY INTEGER NOT NULL, R_NAME CHAR(25) NOT NULL, R_COMMENT VARCHAR(152)) " +
				"ENGINE=FEDERATED CONNECTION='mysql://root@127.0.0.1/tpch_s01/region';");
		
		op.addPrepareSQL("CREATE TABLE R1 ( R_REGIONKEY INTEGER NOT NULL, R_NAME CHAR(25) NOT NULL, R_COMMENT VARCHAR(152)) ENGINE=MEMORY;");
	...
	public void test2Ops() throws Exception {
		...
		op1.addPrepareSQL("CREATE TEMPORARY TABLE REGION ( R_REGIONKEY INTEGER NOT NULL, R_NAME CHAR(25) NOT NULL, R_COMMENT VARCHAR(152)) " +
				"ENGINE=FEDERATED CONNECTION='mysql://root@127.0.0.1/tpch_s01/region';");
		
		op1.addPrepareSQL("CREATE TABLE R1 ( R_REGIONKEY INTEGER NOT NULL, R_NAME CHAR(25) NOT NULL, R_COMMENT VARCHAR(152)) ENGINE=MEMORY;");
		...
		op2.addPrepareSQL("CREATE TEMPORARY TABLE R2 ( R_REGIONKEY INTEGER NOT NULL, R_NAME CHAR(25) NOT NULL, R_COMMENT VARCHAR(152)) " +
				"ENGINE=FEDERATED CONNECTION='mysql://root@127.0.0.1/stratusdb/r1';");
		
		op2.addPrepareSQL("CREATE TABLE R3 ( R_REGIONKEY INTEGER NOT NULL, R_NAME CHAR(25) NOT NULL, R_COMMENT VARCHAR(152)) ENGINE=MEMORY;");
