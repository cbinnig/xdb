...
public class TestTPCHQ5 extends DistributedTPCHTestCase {
	...
	public TestTPCHQ5() {
		...
		this.subqueryDML = "select "
				...
				+ "from  <TPCH_DB_NAME>.customer, <TPCH_DB_NAME>.orders, "
				+ "<TPCH_DB_NAME>.lineitem, <TPCH_DB_NAME>.supplier, <TPCH_DB_NAME>"
				+ ".nation, <TPCH_DB_NAME>.region "
	...
	public void testQ5() throws Exception {
		...
		MySQLTrackerOperator[] q5Ops = new MySQLTrackerOperator[this.numberOfSubops];
