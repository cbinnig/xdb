...
public class TestTPCH_DPUPPLICATE1_W extends DistributedTPCHTestCase  {

	public TestTPCH_DPUPPLICATE1_W() {
		super(-1);
		this.subqueryDDL = "(cust_count INTEGER)";
		this.subqueryDML = "select count(*) as cust_count from <TPCH_DB_NAME>.customer where c_isdupplicated = 0 ";
