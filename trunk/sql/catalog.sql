...
ALTER TABLE `PARTITIONTOCONNECTION`
   	ADD CONSTRAINT `PARTITIONTOCONNECTION_PARTITION_OID_fkey` FOREIGN KEY (`P_OID`) REFERENCES `PARTITION`(`OID`) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE `PARTITIONTOCONNECTION`
   	ADD CONSTRAINT `PARTITIONTOCONNECTION_CONNECTION_OID_fkey` FOREIGN KEY (`C_OID`) REFERENCES `CONNECTION`(`OID`) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE `PARTITIONTOCONNECTION`
    ADD CONSTRAINT `PARTITIONTOCONNECTION_pkey` PRIMARY KEY (`P_OID`,`C_OID`);