...
public class CostModelQueryPlan { 
    ...
    private double bestPlanRunTime; 
    
    private int bestPlanIndex;  
	...
	private void analyzeSingleMatConf(CostModelQueryPlan copyPlan) {
		...
		for(int i=0; i<paths.size();i++){
			...
			MaterlizationStrategyEnumerator costModelApplier = new MaterlizationStrategyEnumerator(2);
			...
			for(int j=pathOpsIds.size() -1 ; j>=0; j--){
				CostModelOperator op = this.operators.get(pathOpsIds.get(j)); 
	...
	/**
	 * @return the bestPlanIndex
	 */
	public int getBestPlanIndex() {
		return bestPlanIndex;
	}

	/**
	 * @param bestPlanIndex the bestPlanIndex to set
	 */
	public void setBestPlanIndex(int bestPlanIndex) {
		this.bestPlanIndex = bestPlanIndex;
	}

	/**
	 * @return the bestPlanRunTime
	 */
	public double getBestPlanRunTime() {
		return bestPlanRunTime;
	}

	/**
	 * @param bestPlanRunTime the bestPlanRunTime to set
	 */
	public void setBestPlanRunTime(double bestPlanRunTime) {
		this.bestPlanRunTime = bestPlanRunTime;
	}
