...
//		final QueryTrackerNode qTracker2 = new QueryTrackerNode("localhost", "localhost", 55545);
//		final QueryTrackerPlan qPlan1 = new QueryTrackerPlan();
//		qPlan1.assignTracker(qTracker1);
//		
//		final QueryTrackerPlan qPlan2 = new QueryTrackerPlan();
//		qPlan2.assignTracker(qTracker2);
//
//		final MySQLTrackerOperator op1 = new MySQLTrackerOperator();
//		final MySQLTrackerOperator op2 = new MySQLTrackerOperator();
//
