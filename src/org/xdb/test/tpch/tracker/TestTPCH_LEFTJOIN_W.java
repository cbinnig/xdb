...
public class TestTPCH_LEFTJOIN_W extends DistributedTPCHTestCase  {

	public TestTPCH_LEFTJOIN_W() {
		super(-1);
		this.subqueryDDL = "(cust_count INTEGER)";
		this.subqueryDML = "select count(*) as cust_count from <TPCH_DB_NAME>.customer where c_hasorder= 0; ";
